...
def get_most_common_month(people):
    ...
    for person in people:
        ...
        months[birthday_month] = months[birthday_month] + 1        
    ...
    for k, v in enumerate(months):
        month = v
        month_birthday_count = int(months[v])
        if month_birthday_count > largest:
            largest_month = month
            largest = month_birthday_count
